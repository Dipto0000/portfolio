...
const HomeDescreption = () => {
  return (
    <div className="w-1/2 d-paragraph">
      <p>
        ...
        . Alongside my studies, I am actively engaged as a research assistant in
        the
        <a
          className="text-blue-500"
        ...
        I am eagerly seeking opportunities to embark on a Ph.D. journey, with a
        keen interest in the intersection of Optimization and Machine Learning.
        My primary goal is to leverage the synergy between these domains to
        drive groundbreaking advancements in business organizations. As part of
        my undergraduate thesis, under the guidance of
        <a
          className="text-blue-500"
